...
namespace WebApi.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public CategoryController(IIdentityService identityService, IApplicationService applicationService, IValidator<PostTransfer> postTransferValidator, IValidator<Budget> budgetValidator)
        {
